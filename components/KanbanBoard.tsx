...
const dummyData: Array<KanbanColumnProps> = [
  {
    id: 1,
    title: 'To Do',
    tasks: [
            ...
            {members.map((member) => {
              ...
              return (
                <>
                  <a
                    href="#"
                    data-tooltip-target={`user_${taskId}_${member.id}`}
                    className="-mr-3"
                  >
                    <img
...
function KanbanColumn({ title, tasks }: KanbanColumnProps): JSX.Element {
  return (
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div className="p-4 md:p-6">
              ...
              <div className="mb-4 space-y-2 text-base text-gray-500 dark:text-gray-400">
                <p>
                  I made some wireframes that we would like you to follow since
                  we are building it in Google’s Material Design (Please learn
                  more about this and see how to improve standard material
                  design into something beautiful). But besides that, you can
              ...
              <div className="flex flex-col space-y-2">
                ...
                <ul className="pl-6 text-xs text-gray-500 list-disc list-outside dark:text-gray-400">
                  <li>
                    ...
                    for merchant, we should instead have a logo that represent
                    the referring traffic sources (ex. Google or Facebook). So
                    we’re actually missing a column that should say “Source”.
                    And there should be no icon for the merchants.
                  </li>
                </ul>
              </div>
            </div>
